    ...
    : IDbSeeder<CatalogDbContext>
{
    public async Task SeedAsync(CatalogDbContext context)
    {
        ...
        if (!context.CatalogItems.Any())
        {
            ...
            context.CatalogBrands.ExecuteDelete();
            ...
            context.CatalogTypes.ExecuteDelete();
            ...
            logger.LogInformation("Seeded catalog with {NumTypes} items", context.CatalogItems.Count());
